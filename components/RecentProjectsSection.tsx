            ...
            return (
              ...
              >
                <Link
                  ...
                  className="relative overflow-hidden aspect-[16/10] block bg-secondary rounded-sm"
                >
                  {imageUrl ? (
                    <motion.img
                      src={imageUrl}
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-10">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <p className="text-primary text-[10px] uppercase tracking-[0.25em] font-bold">
                        {project.projectType || "Architecture"}
                      </p>
                    </div>
                    
                    <h3 className="text-foreground font-heading font-medium text-2xl md:text-3xl mb-2 tracking-tight group-hover:text-primary transition-colors duration-500 leading-tight">
                      {project.title}
                    </h3>
                  </div>
                </Link>
